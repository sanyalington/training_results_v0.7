...
export EXTRA_CONFIG='SOLVER.BASE_LR 0.0075 SOLVER.MAX_ITER 480000 SOLVER.WARMUP_FACTOR 0.000012 SOLVER.WARMUP_ITERS 625 SOLVER.WARMUP_METHOD mlperf_linear SOLVER.STEPS (192000,256000) SOLVER.IMS_PER_BATCH 6 TEST.IMS_PER_BATCH 1 MODEL.RPN.FPN_POST_NMS_TOP_N_TRAIN 6000 NHWC False'
